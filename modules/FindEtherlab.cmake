...
if(UNIX)
    ...
    set(Etherlab_LIBRARY_DIR ${Etherlab_ROOT_DIR}/lib CACHE PATH "the global lib path for Etherlab")
     message(${Etherlab_LIBRARY_DIR})
    if(NOT EXISTS ${Etherlab_LIBRARY_DIR})
        message(FATAL_ERROR "Etherlab: Could not find Etherlab library directory")
    else()
        list(APPEND CMAKE_LIBRARY_PATH ${Etherlab_LIBRARY_DIR})
    endif()
endif()
