...
QButtonSwitch::QButtonSwitch(QWidget* parent, Type type)
    : QWidget(parent)
    , _value(false)
    , _duration(100)
    , _enabled(true)
...
void QButtonSwitch::paintEvent(QPaintEvent*)
{
...
void QButtonSwitch::mousePressEvent(QMouseEvent*)
{
    if (!_enabled)
        return;
...
void QButtonSwitch::setText(const QString& atext)
{
    //setData(Qt::DisplayRole, atext);
}

void QButtonSwitch::setEnabled(bool flag)
{
    _enabled = flag;
...
void QButtonSwitch::setDuration(int time)
{
    _duration = time;
}

void QButtonSwitch::setValue(bool flag)
{
    if (flag == value())
        return;
    else
...
bool QButtonSwitch::value() const
{
    return _value;
}

void QButtonSwitch::_update()
{
    int hback = 20;
    QSize final_size(width() - 4, hback);
...
QButtonSwitch::SwitchBackground::SwitchBackground(QWidget* parent, QColor color, bool rect)
    : QWidget(parent)
    , _rect(rect)
    , _borderradius(12)
    , _color(color)
...
QButtonSwitch::SwitchBackground::~SwitchBackground()
{
}
void QButtonSwitch::SwitchBackground::paintEvent(QPaintEvent*)
{
    QPainter* painter = new QPainter;
    painter->begin(this);
    painter->setRenderHint(QPainter::Antialiasing, true);
...
void QButtonSwitch::SwitchBackground::setEnabled(bool flag)
{
    _enabled = flag;
}

QButtonSwitch::SwitchCircle::SwitchCircle(QWidget* parent, QColor color, bool rect)
    : QWidget(parent)
    , _rect(rect)
    , _borderradius(12)
    , _color(color)
...
QButtonSwitch::SwitchCircle::~SwitchCircle()
{
}
void QButtonSwitch::SwitchCircle::paintEvent(QPaintEvent*)
{
    QPainter* painter = new QPainter;
    painter->begin(this);
    painter->setRenderHint(QPainter::Antialiasing, true);
...
void QButtonSwitch::SwitchCircle::setEnabled(bool flag)
{
    _enabled = flag;
}