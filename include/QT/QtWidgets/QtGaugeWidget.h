...
///////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////
class QCGAUGE_DECL QGaugeWidget : public QWidget
{
    Q_OBJECT
public:
    explicit QGaugeWidget(QWidget *parent = 0);    
    ...
    QcColorBand* addColorBand(float position, QColor fc, float fp, QColor sc, float sp, QColor tc, float tp);
...
public:
    ...
    void setUnitFormat(QString unit);
    QString currentUnitFormat();
