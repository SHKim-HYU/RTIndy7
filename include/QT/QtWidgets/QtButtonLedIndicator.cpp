...
const qreal QButtonLedIndicator::scaledSize = 1000; /* Visual Studio static const mess */

QButtonLedIndicator::QButtonLedIndicator(QWidget *parent) : QAbstractButton(parent)
{
...
void QButtonLedIndicator::resizeEvent(QResizeEvent *event) {
    update();
}

void QButtonLedIndicator::paintEvent(QPaintEvent *event) {
