...
void Master::addSlaveNRMK_Drive(uint16_t alias, uint16_t position, EcatNRMK_Drive* slave)
{
    slave->setSlaveAlias(alias);
    slave->setSlavePosition(position);
