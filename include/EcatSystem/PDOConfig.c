...
ec_pdo_entry_info_t RFTECATV1_pdo_entries[] = {
    {0x7000, 0x01, 16}, //ConfigParam_1		
    {0x6000, 0x01, 32},  // Fx
    {0x6000, 0x02, 32},  // Fy
    {0x6000, 0x03, 32},  // Fz
    {0x6000, 0x04, 32},  // Tx
    {0x6000, 0x05, 32},  // Ty
    {0x6000, 0x06, 32},  // Tz
    {0x6000, 0x07, 32},  // FTS-Status
    {0x6000, 0x08, 32}   // Temperature[Celsius]
};



// PDOs
ec_pdo_info_t RFTECATV1_pdos[] = {
    {0x1600, 1, RFTECATV1_pdo_entries+0} , // 전체 PDO 매핑
    {0x1A00, 8, RFTECATV1_pdo_entries+1}  // 전체 PDO 매핑
};
ec_sync_info_t RFTECATV1_syncs[] = {
    {0, EC_DIR_OUTPUT, 0, NULL, EC_WD_DISABLE},  // SM0
    {1, EC_DIR_INPUT, 0, NULL, EC_WD_DISABLE},   // SM1
    {2, EC_DIR_OUTPUT, 1,RFTECATV1_pdos+0, EC_WD_ENABLE},  // SM2
    {3, EC_DIR_INPUT, 1, RFTECATV1_pdos+1, EC_WD_DISABLE},      // SM3
    {0xff}  // Sync manager 설정 종료
};

unsigned int offset_Fx;
unsigned int offset_Fy;
unsigned int offset_Fz;
unsigned int offset_Tx;
unsigned int offset_Ty;
unsigned int offset_Tz;
unsigned int offset_FTS_Status;
unsigned int offset_Temperature;

const static ec_pdo_entry_reg_t domain_regs[] = {
    {0, 7, RobotusFT_VendorID, Robotus_ProductCode, 0x6000, 0x01, &offset_Fx},
    {0, 7, RobotusFT_VendorID, Robotus_ProductCode, 0x6000, 0x02, &offset_Fy},
    {0, 7, RobotusFT_VendorID, Robotus_ProductCode, 0x6000, 0x03, &offset_Fz},
    {0, 7, RobotusFT_VendorID, Robotus_ProductCode, 0x6000, 0x04, &offset_Tx},
    {0, 7, RobotusFT_VendorID, Robotus_ProductCode, 0x6000, 0x05, &offset_Ty},
    {0, 7, RobotusFT_VendorID, Robotus_ProductCode, 0x6000, 0x06, &offset_Tz},
    {0, 7, RobotusFT_VendorID, Robotus_ProductCode, 0x6000, 0x07, &offset_FTS_Status},
    {0, 7, RobotusFT_VendorID, Robotus_ProductCode, 0x6000, 0x08, &offset_Temperature},
    {}
};
