...
{ 
	public:
		...
		struct NRMK_DRIVE_IN
			...
			struct RFTECATV1_OUT
			{
				INT32		FTRawFx; 	// 0x6000
				INT32		FTRawFy; 	// 0x6000
				INT32		FTRawFz; 	// 0x6000
				INT32		FTRawTx; 	// 0x6000
				INT32		FTRawTy; 	// 0x6000
				INT32		FTRawTz; 	// 0x6000
				INT32		FTOverloadStatus; 	// 0x6000
				INT32		FTTemperature; 	// 0x6000				
			};
			struct RFTECATV1{
				UINT32 Index;
				UINT32 Alias;
				...
				RFTECATV1_IN 	InParam;
				RFTECATV1_OUT 	OutParam;

				UINT32		offFTRawFx; 	// 0x60001
				UINT32		offFTRawFy; 	// 0x60002
				UINT32		offFTRawFz; 	// 0x60003
				UINT32		offFTRawTx; 	// 0x60004
				UINT32		offFTRawTy; 	// 0x60005
				UINT32		offFTRawTz; 	// 0x60006
				UINT32		offFTOverloadStatus; 	// 0x60007
				UINT32		offFTTemperature; 	// 0x6000	8

				UINT32		bitoffFTRawFx; 	// 0x6000
				UINT32		bitoffFTRawFy; 	// 0x6000
				UINT32		bitoffFTRawFz; 	// 0x6000
				UINT32		bitoffFTRawTx; 	// 0x6000
				UINT32		bitoffFTRawTy; 	// 0x6000
				UINT32		bitoffFTRawTz; 	// 0x6000
				UINT32		bitoffFTOverloadStatus; 	// 0x6000
				UINT32		bitoffFTTemperature; 	// 0x6000
	...
	public: 
		NRMK_Master();
		~NRMK_Master();
		void set_slave_state(ec_master_t *master, ec_slave_config_t *sc, ec_state_t state);
	...
	private: 
		...
		RFTECATV1 _RFTECATV1[NUM_FT_SENSORS];
