...
namespace lr {
    ...
    // bool RelIKinSpace(const RelScrewList& Slist, const SE3& M, const SE3& T,RelJVec& thetalist, double eomg, double ev);
    // bool RelIKinBody(const RelScrewList& Blist, const SE3& M, const SE3& T,RelJVec& thetalist, double eomg, double ev);
}
