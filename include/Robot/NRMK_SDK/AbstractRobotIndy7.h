...
#ifndef ABSTRACTROBOTINDY7_H_
#define ABSTRACTROBOTINDY7_H_
...
class AbstractRobotIndy7 : public NRMKFoundation::IndySDK::IndyBase6D
{
public:
	enum
	{
...
public:
    ...
    // virtual void ForwardDynController(AbstractRobotIndy7 & robotNom, JointMat & Mn, JointMat & Cn, JointVec & Gn, TaskPosition const & posDes, TaskVelocity const & velDes, LieGroup::Vector3D const & gravDir) = 0;
