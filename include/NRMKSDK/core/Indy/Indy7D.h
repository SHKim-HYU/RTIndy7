...
#define INDY_NUM_BODIES	8
#define INDY_NUM_JOINTS	7
#define INDY_JOINT_DOF	7
...
namespace IndySDK
{
	class IndyBase7D : public SubsysBase<INDY_NUM_BODIES, INDY_NUM_JOINTS, INDY_JOINT_DOF>
	{
	public:
		//! \brief Provides compile-time constants of the subsys
		enum
		{
			NUM_BODIES = IndyBase7D::NUM_BODIES, //!< Number of bodies
			NUM_JOINTS = IndyBase7D::NUM_JOINTS, //!< Number of joints except the earthing joint
			NUM_TOTAL_JOINTS = IndyBase7D::NUM_TOTAL_JOINTS, //!< Number of total joints including the earthing joint
			JOINT_DOF = IndyBase7D::JOINT_DOF, //!< Total degrees-of-freedom of the system including the earthing joint
			SYSTEM_DOF = IndyBase7D::SYSTEM_DOF, //!< System degrees-of-freedom including the earthing joint dof
		};

		//! \brief Provides Typedefs 
		typedef SubsysBase<INDY_NUM_BODIES, INDY_NUM_JOINTS, INDY_JOINT_DOF> SUBSYSBASE;
		typedef IndyBase7D::JointVec JointVec; //!< Typedef of the vector having the dimension of the total joint dof
		typedef IndyBase7D::JointMat JointMat; //!< Typedef of the square matrix having the dimension of the total joint dof
		typedef IndyBase7D::JointJac JointJac; //!< Typedef of the jacobian matrix having the dimension of six-by-system dof

		typedef IndyBase7D::JointIndex JointIndex;	//!< Joint index vector
		typedef IndyBase7D::VarJointVec VarJointVec; //!< Typedef of the vector having the dimension of the total joint dof
