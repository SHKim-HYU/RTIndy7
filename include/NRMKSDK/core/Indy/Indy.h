...
namespace IndySDK
{
	class NRMKCore_API IndyBase : public SubsysBase<7, 6, 6>
	{
	public:
		//! \brief Provides compile-time constants of the subsys
		enum
		{
			NUM_BODIES = IndyBase::NUM_BODIES, //!< Number of bodies
			NUM_JOINTS = IndyBase::NUM_JOINTS, //!< Number of joints except the earthing joint
			NUM_TOTAL_JOINTS = IndyBase::NUM_TOTAL_JOINTS, //!< Number of total joints including the earthing joint
			JOINT_DOF = IndyBase::JOINT_DOF, //!< Total degrees-of-freedom of the system including the earthing joint
			SYSTEM_DOF = IndyBase::SYSTEM_DOF, //!< System degrees-of-freedom including the earthing joint dof
		};

		//! \brief Provides Typedefs 
		typedef SubsysBase<7, 6, 6> SUBSYSBASE;
		typedef IndyBase::JointVec JointVec; //!< Typedef of the vector having the dimension of the total joint dof
		typedef IndyBase::JointMat JointMat; //!< Typedef of the square matrix having the dimension of the total joint dof
		typedef IndyBase::JointJac JointJac; //!< Typedef of the jacobian matrix having the dimension of six-by-system dof

		typedef IndyBase::JointIndex JointIndex;	//!< Joint index vector
		typedef IndyBase::VarJointVec VarJointVec; //!< Typedef of the vector having the dimension of the total joint dof
	...
	public:
		...
		using SubsysBase<7, 6, 6>::Vdot; // To recover shadowed API in SubsysBase
