...
#ifndef ABSTRACTJOINTCONTROLLER_HPP_
#define ABSTRACTJOINTCONTROLLER_HPP_
...
class AbstractJointController : public NRMKLeanFramework::AbstractComponent
{
public:
...
public:
	AbstractJointController(std::string userName, std::string email, std::string serialNo)
